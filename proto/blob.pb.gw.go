...
var (
	filter_BlobService_GetBlobSidecars_0 = &utilities.DoubleArray{Encoding: map[string]int{"block_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_BlobService_GetBlobSidecars_0(ctx context.Context, marshaler runtime.Marshaler, client BlobServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetBlobSidecarsRequest
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_BlobService_GetBlobSidecars_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetBlobSidecars(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_BlobService_GetBlobSidecars_0(ctx context.Context, marshaler runtime.Marshaler, server BlobServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetBlobSidecarsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetBlobSidecars(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterBlobServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BlobServiceServer) error {
	...
	mux.Handle("GET", pattern_BlobService_GetBlobSidecars_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_BlobService_GetBlobSidecars_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_BlobService_GetBlobSidecars_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBlobServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BlobServiceClient) error {
	...
	mux.Handle("GET", pattern_BlobService_GetBlobSidecars_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_BlobService_GetBlobSidecars_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_BlobService_GetBlobSidecars_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"eth", "v1", "beacon", "blob_sidecars", "block_id"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_BlobService_GetBlobSidecars_0 = runtime.ForwardResponseMessage
)
